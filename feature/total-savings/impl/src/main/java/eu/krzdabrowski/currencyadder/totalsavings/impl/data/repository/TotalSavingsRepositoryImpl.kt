package eu.krzdabrowski.currencyadder.totalsavings.impl.data.repository
...
internal class TotalSavingsRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateChosenCurrencyCodeForTotalSavings(currencyCode: String): Result<Unit> =
        resultOf {
            dataStoreManager
