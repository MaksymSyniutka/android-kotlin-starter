package eu.krzdabrowski.currencyadder.core.utils.kotlin.api.coroutines
...
fun <T, R> Flow<T>.flatMapConcurrently(
    ...
    buffer: Int = eu.krzdabrowski.currencyadder.core.utils.kotlin.api.coroutines.CHANNEL_DEFAULT_CAPACITY,
